...
export default function Quizzical(props) {
    ...
    return (
        <>
            <svg className='q--blue' xmlns="http://www.w3.org/2000/svg" width="148" height="118" viewBox="0 0 148 118" fill="none">
            ...
            <div className='q--container'>
                ...
                <div className='q--subtitile'>
                    Ready for it?
                </div>
                <div className='q--start-btn' onClick={
                    event => { 
                        props.start()
                        handleIsLoading()
                    }
            ...
            <svg className='q--yellow' xmlns="http://www.w3.org/2000/svg" width="158" height="141" viewBox="0 0 158 141" fill="none">
